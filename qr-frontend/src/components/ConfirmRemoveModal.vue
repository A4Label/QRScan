...
<template>
  <TransitionRoot as="template" :show="isOpen">
    <Dialog as="div" class="relative z-10" @close="closeRemoveModal()">
      <TransitionChild
        as="template"
      ...
      <div class="fixed inset-0 z-10 overflow-y-auto" id="modal-content">
        <div
          ...
          >
            ...
            >
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 flex justify-between">
                ...
                <span class="close cursor-pointer" @click="closeRemoveModal">&times;</span>
              </div>
